...
abstract class Tarificationcontainer implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Http\\Model\\Map\\TarificationcontainerTableMap';
     ...
     * @return $this|\App\Http\Model\Tarificationcontainer The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Http\Model\Tarificationcontainer
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Http\Model\Tarificationcontainer The current object, for fluid interface
     */
