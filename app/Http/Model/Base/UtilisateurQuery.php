 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> find(ConnectionInterface $con = null) Return ChildUtilisateur objects based on current ModelCriteria
 * @method     ChildUtilisateur[]|ObjectCollection findByCode(int $code) Return ChildUtilisateur objects filtered by the code column
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByCode(int $code) Return ChildUtilisateur objects filtered by the code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByRaisonsociale(string $raisonSociale) Return ChildUtilisateur objects filtered by the raisonSociale column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByAdresse(string $adresse) Return ChildUtilisateur objects filtered by the adresse column
 * @method     ChildUtilisateur[]|ObjectCollection findByCp(string $cp) Return ChildUtilisateur objects filtered by the cp column
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByCp(string $cp) Return ChildUtilisateur objects filtered by the cp column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByVille(string $ville) Return ChildUtilisateur objects filtered by the ville column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByAdrmel(string $adrMel) Return ChildUtilisateur objects filtered by the adrMel column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByTelephone(string $telephone) Return ChildUtilisateur objects filtered by the telephone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByContact(string $contact) Return ChildUtilisateur objects filtered by the contact column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByCodepays(string $codePays) Return ChildUtilisateur objects filtered by the codePays column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByLogin(string $login) Return ChildUtilisateur objects filtered by the login column
 * @method     ChildUtilisateur[]|ObjectCollection findByMdp(string $mdp) Return ChildUtilisateur objects filtered by the mdp column
 * @psalm-method ObjectCollection&\Traversable<ChildUtilisateur> findByMdp(string $mdp) Return ChildUtilisateur objects filtered by the mdp column
...
abstract class UtilisateurQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('Pays', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Pays', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
