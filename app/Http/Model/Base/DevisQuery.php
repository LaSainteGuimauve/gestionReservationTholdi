 ...
 * @method     ChildDevis|null findOneByNbcontainers(string $nbContainers) Return the first ChildDevis filtered by the nbContainers column
 ...
 * @method     ChildDevis requireOneByNbcontainers(string $nbContainers) Return the first ChildDevis filtered by the nbContainers column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> find(ConnectionInterface $con = null) Return ChildDevis objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByCodedevis(int $codeDevis) Return ChildDevis objects filtered by the codeDevis column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByDatedevis(string $dateDevis) Return ChildDevis objects filtered by the dateDevis column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByMontantdevis(string $montantDevis) Return ChildDevis objects filtered by the montantDevis column
 * @method     ChildDevis[]|ObjectCollection findByVolume(string $volume) Return ChildDevis objects filtered by the volume column
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByVolume(string $volume) Return ChildDevis objects filtered by the volume column
 * @method     ChildDevis[]|ObjectCollection findByNbcontainers(string $nbContainers) Return ChildDevis objects filtered by the nbContainers column
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByNbcontainers(string $nbContainers) Return ChildDevis objects filtered by the nbContainers column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDevis> findByValider(boolean $valider) Return ChildDevis objects filtered by the valider column
