 ...
 */
abstract class Devis implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Http\\Model\\Map\\DevisTableMap';
    ...
    /**
     * The value for the datedevis field.
     *
     * @var        string
     */
    protected $datedevis;
    ...
    /**
     * The value for the montantdevis field.
     *
     * @var        string
     */
    protected $montantdevis;
    ...
    /**
     * The value for the nbcontainers field.
     *
     * @var        string|null
     */
    protected $nbcontainers;

    /**
     * The value for the valider field.
     *
    ...
    /**
     * Initializes internal state of App\Http\Model\Base\Devis object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Devis</code> instance.  If
     * <code>obj</code> is an instance of <code>Devis</code>, delegates to
     * <code>equals(Devis)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [datedevis] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [montantdevis] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [nbcontainers] column value.
     *
     * @return string|null
     */
     ...
     * @return $this|\App\Http\Model\Devis The current object (for fluent API support)
     */
    public function setCodedevis($v)
    {
        ...
        if ($this->codedevis !== $v) {
            $this->codedevis = $v;
            $this->modifiedColumns[DevisTableMap::COL_CODEDEVIS] = true;
        }
    ...
    /**
     * Set the value of [datedevis] column.
     *
     * @param string $v New value
     * @return $this|\App\Http\Model\Devis The current object (for fluent API support)
     */
    public function setDatedevis($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->datedevis !== $v) {
            $this->datedevis = $v;
            $this->modifiedColumns[DevisTableMap::COL_DATEDEVIS] = true;
        }
    ...
    /**
     * Set the value of [montantdevis] column.
     *
     * @param string $v New value
     * @return $this|\App\Http\Model\Devis The current object (for fluent API support)
     */
    public function setMontantdevis($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->montantdevis !== $v) {
            $this->montantdevis = $v;
            $this->modifiedColumns[DevisTableMap::COL_MONTANTDEVIS] = true;
        }
    ...
    public function setVolume($v)
    {
        ...
        if ($this->volume !== $v) {
            $this->volume = $v;
            $this->modifiedColumns[DevisTableMap::COL_VOLUME] = true;
        }
    ...
    /**
     * Set the value of [nbcontainers] column.
     *
     * @param string|null $v New value
     * @return $this|\App\Http\Model\Devis The current object (for fluent API support)
     */
    public function setNbcontainers($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nbcontainers !== $v) {
            $this->nbcontainers = $v;
            $this->modifiedColumns[DevisTableMap::COL_NBCONTAINERS] = true;
        }
    ...
    /**
     * Sets the value of the [valider] column.
    ...
    public function setValider($v)
    {
        ...
        if ($this->valider !== $v) {
            $this->valider = $v;
            $this->modifiedColumns[DevisTableMap::COL_VALIDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DevisTableMap::translateFieldName('Codedevis', TableMap::TYPE_PHPNAME, $indexType)];
            $this->codedevis = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DevisTableMap::translateFieldName('Datedevis', TableMap::TYPE_PHPNAME, $indexType)];
            $this->datedevis = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DevisTableMap::translateFieldName('Montantdevis', TableMap::TYPE_PHPNAME, $indexType)];
            $this->montantdevis = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DevisTableMap::translateFieldName('Volume', TableMap::TYPE_PHPNAME, $indexType)];
            $this->volume = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DevisTableMap::translateFieldName('Nbcontainers', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nbcontainers = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DevisTableMap::translateFieldName('Valider', TableMap::TYPE_PHPNAME, $indexType)];
            $this->valider = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = DevisTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Http\\Model\\Devis'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDevisQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDevisQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DevisTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DevisTableMap::COL_CODEDEVIS] = true;
        if (null !== $this->codedevis) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DevisTableMap::COL_CODEDEVIS . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DevisTableMap::COL_CODEDEVIS)) {
            $modifiedColumns[':p' . $index++]  = 'codeDevis';
        }
        if ($this->isColumnModified(DevisTableMap::COL_DATEDEVIS)) {
            $modifiedColumns[':p' . $index++]  = 'dateDevis';
        }
        if ($this->isColumnModified(DevisTableMap::COL_MONTANTDEVIS)) {
            $modifiedColumns[':p' . $index++]  = 'montantDevis';
        }
        if ($this->isColumnModified(DevisTableMap::COL_VOLUME)) {
            $modifiedColumns[':p' . $index++]  = 'volume';
        }
        if ($this->isColumnModified(DevisTableMap::COL_NBCONTAINERS)) {
            $modifiedColumns[':p' . $index++]  = 'nbContainers';
        }
        if ($this->isColumnModified(DevisTableMap::COL_VALIDER)) {
            $modifiedColumns[':p' . $index++]  = 'valider';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'codeDevis':
                        ...
                        break;
                    case 'dateDevis':
                        $stmt->bindValue($identifier, $this->datedevis, PDO::PARAM_INT);
                        break;
                    case 'montantDevis':
                        $stmt->bindValue($identifier, $this->montantdevis, PDO::PARAM_STR);
                        break;
                    case 'volume':
                        $stmt->bindValue($identifier, $this->volume, PDO::PARAM_STR);
                        break;
                    case 'nbContainers':
                        $stmt->bindValue($identifier, $this->nbcontainers, PDO::PARAM_STR);
                        break;
                    case 'valider':
                        $stmt->bindValue($identifier, (int) $this->valider, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = DevisTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getDatedevis();
                break;
            case 2:
                return $this->getMontantdevis();
                break;
            case 3:
                return $this->getVolume();
                break;
            case 4:
                return $this->getNbcontainers();
                break;
            case 5:
                return $this->getValider();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Devis'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Devis'][$this->hashCode()] = true;
        $keys = DevisTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCodedevis(),
            $keys[1] => $this->getDatedevis(),
            $keys[2] => $this->getMontantdevis(),
            $keys[3] => $this->getVolume(),
            $keys[4] => $this->getNbcontainers(),
            $keys[5] => $this->getValider(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Http\Model\Devis
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setDatedevis($value);
                break;
            case 2:
                $this->setMontantdevis($value);
                break;
            case 3:
                $this->setVolume($value);
                break;
            case 4:
                $this->setNbcontainers($value);
                break;
            case 5:
                $this->setValider($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCodedevis($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDatedevis($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setMontantdevis($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setVolume($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setNbcontainers($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setValider($arr[$keys[5]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Http\Model\Devis The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DevisTableMap::COL_CODEDEVIS)) {
            $criteria->add(DevisTableMap::COL_CODEDEVIS, $this->codedevis);
        }
        if ($this->isColumnModified(DevisTableMap::COL_DATEDEVIS)) {
            $criteria->add(DevisTableMap::COL_DATEDEVIS, $this->datedevis);
        }
        if ($this->isColumnModified(DevisTableMap::COL_MONTANTDEVIS)) {
            $criteria->add(DevisTableMap::COL_MONTANTDEVIS, $this->montantdevis);
        }
        if ($this->isColumnModified(DevisTableMap::COL_VOLUME)) {
            $criteria->add(DevisTableMap::COL_VOLUME, $this->volume);
        }
        if ($this->isColumnModified(DevisTableMap::COL_NBCONTAINERS)) {
            $criteria->add(DevisTableMap::COL_NBCONTAINERS, $this->nbcontainers);
        }
        if ($this->isColumnModified(DevisTableMap::COL_VALIDER)) {
            $criteria->add(DevisTableMap::COL_VALIDER, $this->valider);
        }
    ...
    {
        $criteria = ChildDevisQuery::create();
        $criteria->add(DevisTableMap::COL_CODEDEVIS, $this->codedevis);
    ...
    {
        $validPk = null !== $this->getCodedevis();
    ...
    /**
     * Generic method to set the primary key (codedevis column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Http\Model\Devis (or compatible) type.
    ...
    {
        $copyObj->setDatedevis($this->getDatedevis());
        $copyObj->setMontantdevis($this->getMontantdevis());
        $copyObj->setVolume($this->getVolume());
        $copyObj->setNbcontainers($this->getNbcontainers());
        $copyObj->setValider($this->getValider());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCodedevis(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Http\Model\Devis Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDevis is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDevis The current object (for fluent API support)
     */
    public function setReservations(Collection $reservations, ConnectionInterface $con = null)
    {
        ...
        foreach ($reservationsToDelete as $reservationRemoved) {
            $reservationRemoved->setDevis(null);
        }
     ...
     * Otherwise if this Devis is new, it will return
     * an empty collection; or if this Devis has previously
     * been saved, it will retrieve related Reservations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Devis.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildReservation}> List of ChildReservation objects
     */
    public function getReservationsJoinUtilisateur(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildReservationQuery::create(null, $criteria);
    ...
    public function clear()
    {
        $this->codedevis = null;
        $this->datedevis = null;
        $this->montantdevis = null;
        $this->volume = null;
        $this->nbcontainers = null;
        $this->valider = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
    ...
    {
        return (string) $this->exportTo(DevisTableMap::DEFAULT_STRING_FORMAT);
    }
