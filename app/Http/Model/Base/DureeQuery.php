 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDuree> find(ConnectionInterface $con = null) Return ChildDuree objects based on current ModelCriteria
 * @method     ChildDuree[]|ObjectCollection findByCode(string $code) Return ChildDuree objects filtered by the code column
 * @psalm-method ObjectCollection&\Traversable<ChildDuree> findByCode(string $code) Return ChildDuree objects filtered by the code column
 * @method     ChildDuree[]|ObjectCollection findByNbjours(int $nbJours) Return ChildDuree objects filtered by the nbJours column
 * @psalm-method ObjectCollection&\Traversable<ChildDuree> findByNbjours(int $nbJours) Return ChildDuree objects filtered by the nbJours column
