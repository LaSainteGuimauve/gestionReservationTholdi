 ...
 * @psalm-method ObjectCollection&\Traversable<ChildTarificationcontainer> find(ConnectionInterface $con = null) Return ChildTarificationcontainer objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildTarificationcontainer> findByCodeduree(string $codeDuree) Return ChildTarificationcontainer objects filtered by the codeDuree column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildTarificationcontainer> findByNumtypecontainer(int $numTypeContainer) Return ChildTarificationcontainer objects filtered by the numTypeContainer column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildTarificationcontainer> findByTarif(string $tarif) Return ChildTarificationcontainer objects filtered by the tarif column
...
abstract class TarificationcontainerQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('Duree', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Duree', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
