 ...
 * @psalm-method ObjectCollection&\Traversable<ChildVille> find(ConnectionInterface $con = null) Return ChildVille objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildVille> findByCodeville(int $codeVille) Return ChildVille objects filtered by the codeVille column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildVille> findByNomville(string $nomVille) Return ChildVille objects filtered by the nomVille column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildVille> findByCodepays(string $codePays) Return ChildVille objects filtered by the codePays column
...
abstract class VilleQuery extends ModelCriteria
{
    ...
    /**
     * Use the ReservationRelatedByCodevillemisedisposition relation to the Reservation table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     ...
     */
    public function useReservationRelatedByCodevillemisedispositionExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        return $this->useExistsQuery('ReservationRelatedByCodevillemisedisposition', $modelAlias, $queryClass, $typeOfExists);
    }

    /**
     * Use the ReservationRelatedByCodevillemisedisposition relation to the Reservation table for a NOT EXISTS query.
     *
     * @see useReservationRelatedByCodevillemisedispositionExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useReservationRelatedByCodevillemisedispositionNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        return $this->useExistsQuery('ReservationRelatedByCodevillemisedisposition', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \App\Http\Model\Reservation object
     *
    ...
    {
        return $this->useExistsQuery('ReservationRelatedByCodevillerendre', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ReservationRelatedByCodevillerendre', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
