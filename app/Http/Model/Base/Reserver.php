...
/**
 * Base class that represents a row from the 'reserver' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Reserver implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Http\\Model\\Map\\ReserverTableMap';
    ...
    /**
     * The value for the qtereserver field.
     *
     * @var        string
     */
    protected $qtereserver;
    ...
    /**
     * Initializes internal state of App\Http\Model\Base\Reserver object.
     */
    ...
    /**
     * Compares this with another <code>Reserver</code> instance.  If
     * <code>obj</code> is an instance of <code>Reserver</code>, delegates to
     * <code>equals(Reserver)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [qtereserver] column value.
     *
     * @return string
     */
    public function getQtereserver()
    {
        return $this->qtereserver;
    }
     ...
     * @return $this|\App\Http\Model\Reserver The current object (for fluent API support)
     */
    public function setCodereservation($v)
    {
        ...
        if ($this->codereservation !== $v) {
            ...
            $this->modifiedColumns[ReserverTableMap::COL_CODERESERVATION] = true;
        }

        if ($this->aReservation !== null && $this->aReservation->getCodereservation() !== $v) {
    ...
    public function setNumtypecontainer($v)
    {
        ...
        if ($this->numtypecontainer !== $v) {
            ...
            $this->modifiedColumns[ReserverTableMap::COL_NUMTYPECONTAINER] = true;
        }
    ...
    /**
     * Set the value of [qtereserver] column.
     *
     * @param string $v New value
     * @return $this|\App\Http\Model\Reserver The current object (for fluent API support)
     */
    public function setQtereserver($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->qtereserver !== $v) {
            $this->qtereserver = $v;
            $this->modifiedColumns[ReserverTableMap::COL_QTERESERVER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ReserverTableMap::translateFieldName('Codereservation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->codereservation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReserverTableMap::translateFieldName('Numtypecontainer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numtypecontainer = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReserverTableMap::translateFieldName('Qtereserver', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtereserver = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ReserverTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Http\\Model\\Reserver'), 0, $e);
        }
    }
    ...
    {
        if ($this->aReservation !== null && $this->codereservation !== $this->aReservation->getCodereservation()) {
            $this->aReservation = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildReserverQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Reserver::setDeleted()
     * @see Reserver::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildReserverQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ReserverTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReserverTableMap::COL_CODERESERVATION)) {
            $modifiedColumns[':p' . $index++]  = 'codeReservation';
        }
        if ($this->isColumnModified(ReserverTableMap::COL_NUMTYPECONTAINER)) {
            $modifiedColumns[':p' . $index++]  = 'numTypeContainer';
        }
        if ($this->isColumnModified(ReserverTableMap::COL_QTERESERVER)) {
            $modifiedColumns[':p' . $index++]  = 'qteReserver';
        }

        $sql = sprintf(
            'INSERT INTO reserver (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'numTypeContainer':
                        ...
                        break;
                    case 'qteReserver':
                        $stmt->bindValue($identifier, $this->qtereserver, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = ReserverTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Reserver'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Reserver'][$this->hashCode()] = true;
        $keys = ReserverTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCodereservation(),
            $keys[1] => $this->getNumtypecontainer(),
            $keys[2] => $this->getQtereserver(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Http\Model\Reserver
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setQtereserver($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Http\Model\Reserver The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReserverTableMap::COL_CODERESERVATION)) {
            $criteria->add(ReserverTableMap::COL_CODERESERVATION, $this->codereservation);
        }
        if ($this->isColumnModified(ReserverTableMap::COL_NUMTYPECONTAINER)) {
            $criteria->add(ReserverTableMap::COL_NUMTYPECONTAINER, $this->numtypecontainer);
        }
        if ($this->isColumnModified(ReserverTableMap::COL_QTERESERVER)) {
            $criteria->add(ReserverTableMap::COL_QTERESERVER, $this->qtereserver);
        }
    ...
    {
        $criteria = ChildReserverQuery::create();
        $criteria->add(ReserverTableMap::COL_CODERESERVATION, $this->codereservation);
        $criteria->add(ReserverTableMap::COL_NUMTYPECONTAINER, $this->numtypecontainer);
    ...
    public function hashCode()
    {
        ...
        //relation reserver_ibfk_1 to table typeContainer
        ...
        //relation reserver_ibfk_2 to table reservation
    ...
    {
        $this->setCodereservation($keys[0]);
    ...
    {
        return (null === $this->getCodereservation()) && (null === $this->getNumtypecontainer());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Http\Model\Reserver (or compatible) type.
    ...
    {
        $copyObj->setCodereservation($this->getCodereservation());
        $copyObj->setNumtypecontainer($this->getNumtypecontainer());
        $copyObj->setQtereserver($this->getQtereserver());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Http\Model\Reserver Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTypecontainer(ConnectionInterface $con = null)
    {
        if ($this->aTypecontainer === null && ($this->numtypecontainer != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTypecontainer->addReservers($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setCodereservation(NULL);
        } else {
            $this->setCodereservation($v->getCodereservation());
        }
    ...
    {
        if ($this->aReservation === null && ($this->codereservation != 0)) {
            $this->aReservation = ChildReservationQuery::create()->findPk($this->codereservation, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aReservation->addReservers($this);
             */
        }
    ...
    {
        if (null !== $this->aTypecontainer) {
            $this->aTypecontainer->removeReserver($this);
        }
        if (null !== $this->aReservation) {
            $this->aReservation->removeReserver($this);
        }
        $this->codereservation = null;
        $this->numtypecontainer = null;
        $this->qtereserver = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(ReserverTableMap::DEFAULT_STRING_FORMAT);
    }
