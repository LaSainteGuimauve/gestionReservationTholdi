 ...
 * @psalm-method ObjectCollection&\Traversable<ChildPays> find(ConnectionInterface $con = null) Return ChildPays objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildPays> findByCodepays(string $codePays) Return ChildPays objects filtered by the codePays column
 * @method     ChildPays[]|ObjectCollection findByNompays(string $nomPays) Return ChildPays objects filtered by the nomPays column
 * @psalm-method ObjectCollection&\Traversable<ChildPays> findByNompays(string $nomPays) Return ChildPays objects filtered by the nomPays column
...
abstract class PaysQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('Ville', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Ville', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
