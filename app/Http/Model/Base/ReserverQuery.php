 ...
 * @psalm-method ObjectCollection&\Traversable<ChildReserver> find(ConnectionInterface $con = null) Return ChildReserver objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildReserver> findByCodereservation(int $codeReservation) Return ChildReserver objects filtered by the codeReservation column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildReserver> findByNumtypecontainer(int $numTypeContainer) Return ChildReserver objects filtered by the numTypeContainer column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildReserver> findByQtereserver(string $qteReserver) Return ChildReserver objects filtered by the qteReserver column
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildReserver> paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
abstract class ReserverQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('Typecontainer', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Typecontainer', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
